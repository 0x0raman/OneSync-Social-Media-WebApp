...
//               fullWidth
//               sx={{ borderRadius: "0.75rem", paddingRight: "1rem" }}
//             />
...
//               placeholder="Add a comment..."
//               fullWidth
//               sx={{ borderRadius: "2rem", backgroundColor: "#F0F2F5", py: '0.5rem', pl: '1rem', flexGrow: 1 }}
//             />
...
//               </Typography>
//               <Typography
//                 sx={{ color: main, ml: "0.5rem", whiteSpace: "pre-wrap" }}
//               >
//                 {comment.comment}
//               </Typography>
//             </Box>
...
//               key={`${name}-${i}`}
//               display="flex"
//               alignItems="flex-start" // Wrap text around comment
//               sx={{ m: "0.5rem 0", pl: "1rem" }}
//             >
//               <Avatar
//                 sx={{ width: 32, height: 32, mr: "0.5rem" }}
...
//                 </Typography>
//                 <Typography
//                   sx={{ color: main, whiteSpace: "pre-wrap" }} // Allow text wrapping
//                 >
//                   {comment.comment}
//                 </Typography>
//               </Box>
...
//                 fontSize: '0.875rem',
//                 lineHeight: '1.3',
//                 overflowWrap: 'break-word', // Wrap text inside input box
//                 wordWrap: 'break-word', // Wrap text inside input box
//                 wordBreak: 'break-word', // Wrap text inside input box
//               }}
//             />
